...
object Compiler extends App {
  ...
  val l1 = StringLiteral("e1:1", "e1:1")
  val l2 = StringLiteral("e2:1", "e2:1")
  val ll = ListLiteral("ll", List(l1, l2))
  ...
  val l3 = StringLiteral("1.0.0.1", "1.0.0.1")
  val l4 = StringLiteral("1.0.0.2", "1.0.0.2")
  val l5 = StringLiteral("e1:1", "e1:1")
  val l6 = StringLiteral("e2:1", "e2:1")
  val ml = MapLiteral("ml", Map(l3 -> l5, l4 -> l6))
